...
export function orderConfirmationEmail(name: string, orderId: string, total: number, items: any[]): string {
...
export function orderStatusUpdateEmail(name: string, orderId: string, status: string, trackingId?: string, note?: string): string {
