...
const FAQ_DATA = [
  ...
  },
  {
    ...
    icon: Gift,
    questions: [
      { q: "Do you offer discounts for bulk orders?", a: "Yes, we have specialized pricing for corporate gifting and bulk orders (20+ units). Reach out to us at support@prettyluxeatelier.com." },
          ...
          <div className="mt-24 p-12 bg-white rounded-[4rem] text-center border border-brand-100 shadow-2xl shadow-brand-900/5 overflow-hidden relative group">
             ...
             <div className="relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                   <a href="mailto:support@prettyluxeatelier.com" className="px-8 py-4 bg-brand-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:bg-brand-800 transition-all shadow-xl shadow-brand-900/20 active:scale-95">Shoot an Email</a>
                   <a href="https://wa.me/27640129242" className="px-8 py-4 bg-[#25D366] text-white rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] hover:shadow-xl transition-all active:scale-95">Chat on WhatsApp</a>
                </div>
             </div>
          </div>
        </div>
